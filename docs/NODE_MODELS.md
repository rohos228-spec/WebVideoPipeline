...
| ~~Nano Banana~~ (скрыта из пикера, есть v2) | `nano-banana` | `nano_banana` | `IMAGE_PROVIDER` |
| Nano Banana 2 (1K/2K/4K) | `nano-banana-2` | `nano_banana_2` | **`OUTSEE_API_KEY`** |
| ~~Nano Banana Pro (1K/2K/4K)~~ (скрыта из пикера; алиасы оставлены для старых проектов) | `nano-banana-pro` | `nano_banana_pro` | `IMAGE_PROVIDER` |
