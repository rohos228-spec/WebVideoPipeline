...
**Дата:** 2026-09-03 (черновик v0.1, до закрытия двух ревью — см. §7)
...
### 3.3 Оркестрация (Kir0029, этапы 1–15) — ОТКРЫТО, ревью в работе
### 3.4 Цепочка текстовых нод и промтов — ОТКРЫТО, ревью в работе
