...
/**
 * Режим владельца: личностей нет, инструменты хозяина на месте.
 *
 * Половина верхней панели — инструменты, а не продукт: парк машин, прямой
 * обозреватель базы, ручки к провайдерам мимо кассы, промты платформы. В
 * SaaS их ручки закрыты списком разрешённого, но КНОПКИ оставались видны — и
 * клиент нажимал на то, что молча отвечает 404. Кнопка, ведущая в никуда,
 * хуже отсутствующей: она обещает возможность.
 */
