...
Источник стиля: «треш полька акварель» v2.10 — в `промт_картинки` пиши
**ПОЛНЫЙ промт: сцена + STYLE LOCK / Final style lock / Negative из мастера**.
Оркестратор НИЧЕГО не дописывает перед Outsee.
