...
_STATUS_ORDER: dict[ProjectStatus, int] = {
    ...
    # ord уникальны (этап 2, находка §9#3 карты): коллизии ломали
    # сравнения «дальше/раньше» для хвоста music/sfx/assemble.
...
def project_header(project: Project) -> str:
    ...
    settings_line = render_settings_summary(
        ...
        image_quality=getattr(project, "image_quality", None),
